 ...
 * @param {*} idBike codigo de la bicicleta
 * @param {*} infCostume informacion adicional de la bicicleta
 */
 function mostrarEliminar(idBike,infBike){
    ...
    $("#listado").hide();
    $("#nuevoRegistro").hide();
    $("#titleIdDelete").html("Desea eliminar La bicicleta con el id: " + idBike + " ?...");    
    $("#idDelete").val(idBike);
...
function borrarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "http://129.151.113.72:8080/api/Bike/" + llaveRegistro,
        ...
        error: function (xhr, status) {
            $("#mensajes").html("La bicicleta que intenta eliminar tiene información relacionada, por favor verifique...");
            $("#mensajes").show(1000);
        }
    });
}